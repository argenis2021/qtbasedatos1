...
from listaproductos import Ui_MainWindow
import sqlite3
import sys
...
#Iniciamos la base de datos y creamos la tabla si no existe
    ...
    # Se cargan los datos indicados de la tabla
        ...
        self.ui.tblproductos.setColumnCount(database_table_column_count)
    			   
    	   
    	 
        self.numerodefilas = len(table_info)
        self.ui.tblproductos.setRowCount(self.numerodefilas)
   	    #print filas[0]
        for j in range(self.numerodefilas):
          ...
          for i in range(0, len(fila)):
            ...
            self.ui.tblproductos.setItem(j, i, newitem) 
